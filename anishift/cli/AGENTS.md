...
- Współbieżny LLM pokazuje trwałe linie start/stan końcowy per plik zamiast drugiego Rich Live, ponieważ ekstrakcja i translacja mogą działać jednocześnie. `pipeline_ui.py`
