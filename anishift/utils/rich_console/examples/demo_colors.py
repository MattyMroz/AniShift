...
def demo_colors() -> None:
    ...
    # ── 1. URLs → repr.url (blue underline) ───────────────────────────────────
    ...
    # ── 2. File Paths → repr.path (ruby_red) ──────────────────────────────────
    ...
    console.print("  Relative 3+: output/volume_01/chapter_03/")
    console.print("  With ext: volume_01/chapter_01.cbz")
    console.print("  NOT a path: 24/24 panels (→ fraction)")
    console.print()

    # ── 3. Booleans → repr.bool_true / repr.bool_false ────────────────────────
    ...
    console.print("  Progress: 24/24 pages processed")
    console.print()
    ...
    console.print("  Commas:     files: 24, size: 12MB, pages: 156")
    ...
    console.print("  OCR v2.1.0: processed 24/24 pages, avg 42ms/page")
    console.print("  Pipeline complete: 156/156 regions, output: 245MB")
    console.print("  CUDA: True, torch 2.6.0+cu128, Python 3.13.11")
    console.print("  Saved to output/volume_01/chapter_03/page_001.png")
