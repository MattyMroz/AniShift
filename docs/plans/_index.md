...
| 7 | [etap-7-wymagania.md](etap-7-wymagania.md) + [etap-7-plan.md](etap-7-plan.md) | **AKTUALNE** — składanie wyniku (players / merge mkv / burn mp4), macierz kombinacji, `/compose` bez tłumaczenia i TTS, pełne e2e od Enter do gotowego pliku. Zastępuje szkic [etap-7-skladanie-e2e.md](etap-7-skladanie-e2e.md). | 6 |
